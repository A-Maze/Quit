...
public class SplashScreen extends Activity {
    ...
    private void fillDataBase() {
        ...
        //Sigaretten
        db.addSigarette(new Sigaretten(4,2f,"Camel 19",19,4,5.5f));
        db.addSigarette(new Sigaretten(4,2f,"Camel 21",21,4,6f));
        db.addSigarette(new Sigaretten(4,2f,"Camel 22",22,4,6.6f));
        db.addSigarette(new Sigaretten(4,2f,"Camel 25",25,4,7.6f));
        db.addSigarette(new Sigaretten(4,2f,"Camel 27",27,4,7.8f));

        db.addSigarette(new Sigaretten(4,2f,"Chesterfield 19",19,4,5.8f));
        db.addSigarette(new Sigaretten(4,2f,"Chesterfield 22",22,4,6.5f));

        db.addSigarette(new Sigaretten(4,2f,"Kent 19",19,4,6f));
        db.addSigarette(new Sigaretten(4,2f,"Kent 22",22,4,7f));

        db.addSigarette(new Sigaretten(4,2f,"L&M",19,4,5.4f));
        db.addSigarette(new Sigaretten(4,2f,"L&M",22,4,5.9f));
        db.addSigarette(new Sigaretten(4,2f,"L&M",27,4,7.5f));

        db.addSigarette(new Sigaretten(4,2f,"Lucky Strike 19",19,4,5.8f));
        db.addSigarette(new Sigaretten(4,2f,"Lucky Strike 22",27,4,6.5f));

        db.addSigarette(new Sigaretten(4,2f,"Marlboro 19",19,4,6f));
        db.addSigarette(new Sigaretten(4,2f,"Marlboro 23",23,4,7f));
        db.addSigarette(new Sigaretten(4,2f,"Marlboro 27",27,4,8f));

        db.addSigarette(new Sigaretten(4,2f,"Pall Mall 19",19,4,5.4f));
        db.addSigarette(new Sigaretten(4,2f,"Pall Mall 22",22,4,6.3f));
        db.addSigarette(new Sigaretten(4,2f,"Pall Mall 27",27,4,7.5f));

        db.addSigarette(new Sigaretten(4,2f,"Winston 19",19,4,5.4f));
        db.addSigarette(new Sigaretten(4,2f,"Winston 21",21,4,6f));
        db.addSigarette(new Sigaretten(4,2f,"Winston 26",26,4,7.1f));
